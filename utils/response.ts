...
export function send(data: string, res_headers = {}) {
...
export function error(data: string, code = 400, res_headers = {}) {
...
export function json(data: object, res_headers = {}) {
...
export function redirect(url: string, status = 302, res_headers = {}) {
...
export function html(data: string, res_headers = {}) {
...
export async function view(file: string, res_headers = {}) {
